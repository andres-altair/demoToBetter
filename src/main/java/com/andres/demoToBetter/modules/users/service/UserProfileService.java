...
public class UserProfileService {
    ...
    public UserProfileDTO save(@NonNull UserProfileCreateDTO dto) {
        ...
        userSecurity.setUsername(UUID.randomUUID().toString());
        if (userSecurityRepository.findByEmail(dto.getEmail()).isPresent()) {
            throw new BadRequestException(ERR_BAD_REQUEST, "Email already in use");
        }
        userSecurity.setEmail(dto.getEmail());
        ...
        profile.setUserSecurity(userSecurity);
